...
public class Elektronika extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       databasepath="Elektronika Semestri 1";

        recyclerView=(RecyclerView)findViewById(R.id.recyclerMaterialiComp);
        ...
        fileUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editPdfName.getText().toString().equals("")) {
                    final Dialog dialog=new Dialog(Elektronika.this);
            ...
            public void onClick(View v) {
                databasepath="Elektronika Semestri 1";
                sem1.setBackgroundColor(WHITE);
                sem1.setTextColor(parseColor("#2196f3"));
                sem2.setBackgroundColor(parseColor("#2196f3"));
                sem2.setTextColor(parseColor("#ffffff"));
                sem3.setBackgroundColor(parseColor("#2196f3"));
                sem3.setTextColor(parseColor("#ffffff"));
                sem4.setBackgroundColor(parseColor("#2196f3"));
                sem4.setTextColor(parseColor("#ffffff"));
                sem5.setBackgroundColor(parseColor("#2196f3"));
                sem5.setTextColor(parseColor("#ffffff"));
                sem6.setBackgroundColor(parseColor("#2196f3"));
                sem6.setTextColor(parseColor("#ffffff"));
                displayUpload();
            }
        });
        sem2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Elektronika Semestri 2";
                sem2.setBackgroundColor(WHITE);
                sem2.setTextColor(parseColor("#2196f3"));
                sem1.setBackgroundColor(parseColor("#2196f3"));
                sem1.setTextColor(parseColor("#ffffff"));
                sem3.setBackgroundColor(parseColor("#2196f3"));
                sem3.setTextColor(parseColor("#ffffff"));
                sem4.setBackgroundColor(parseColor("#2196f3"));
                sem4.setTextColor(parseColor("#ffffff"));
        ...
        sem3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Elektronika Semestri 3";
                sem3.setBackgroundColor(WHITE);
                sem3.setTextColor(parseColor("#2196f3"));
                sem2.setBackgroundColor(parseColor("#2196f3"));
                sem2.setTextColor(parseColor("#ffffff"));
                sem1.setBackgroundColor(parseColor("#2196f3"));
                sem1.setTextColor(parseColor("#ffffff"));
        ...
        sem4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Elektronika Semestri 4";
                sem4.setBackgroundColor(WHITE);
                sem4.setTextColor(parseColor("#2196f3"));
                sem2.setBackgroundColor(parseColor("#2196f3"));
                sem2.setTextColor(parseColor("#ffffff"));
                sem3.setBackgroundColor(parseColor("#2196f3"));
                sem3.setTextColor(parseColor("#ffffff"));
        ...
        sem5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Elektronika Semestri 5";
                sem5.setBackgroundColor(WHITE);
                sem5.setTextColor(parseColor("#2196f3"));
                sem2.setBackgroundColor(parseColor("#2196f3"));
                sem2.setTextColor(parseColor("#ffffff"));
                sem3.setBackgroundColor(parseColor("#2196f3"));
                sem3.setTextColor(parseColor("#ffffff"));
        ...
        sem6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Elektronika Semestri 6";
                sem6.setBackgroundColor(WHITE);
                sem6.setTextColor(parseColor("#2196f3"));
                sem2.setBackgroundColor(parseColor("#2196f3"));
                sem2.setTextColor(parseColor("#ffffff"));
                sem3.setBackgroundColor(parseColor("#2196f3"));
                sem3.setTextColor(parseColor("#ffffff"));
    ...
    private void uploadFile(Uri data) {
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Elektronika.this, "Upload successful!", Toast.LENGTH_SHORT).show();
                reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(Elektronika.this, "File Uploaded", Toast.LENGTH_SHORT).show();
    ...
    public void displayUpload(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter=new MaterialiAdapter(Elektronika.this,upload);
                recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Elektronika.this,"Probleme me Databaze",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
             Intent intent=new Intent(Elektronika.this, MainActivityHome.class);
             startActivity(intent);
        }
       else  if (id == R.id.literatura) {
            Intent intent=new Intent(Elektronika.this, DrejtimetMain.class);
            startActivity(intent);
        }
        else if (id == R.id.syllabusi) {
            Intent intent=new Intent(Elektronika.this, Syllabusi.class);
            startActivity(intent);
        } else if (id == R.id.njoftime) {
            Intent intent=new Intent(Elektronika.this, Njoftime.class);
            startActivity(intent);
        } else if (id == R.id.about) {
            Intent intent=new Intent(Elektronika.this, AboutUs.class);
            startActivity(intent);
        } else if (id == R.id.facebook) {
            Intent intent=new Intent(Elektronika.this, Facebook.class);
            startActivity(intent);

        } else if (id == R.id.online) {
            url_web_page="https://notimi.uni-pr.edu/";
            Intent intent=new Intent(Elektronika.this, Web_Page.class);
            startActivity(intent);
        }
    ...
    private void logout() {
        ...
        finish();
        Toast.makeText(Elektronika.this,"User logged out",Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Elektronika.this,MainActivityLogin.class));
    }
