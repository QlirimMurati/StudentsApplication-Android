...
public class Telekomunikacioni extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telekomunikacioni);
        ...
        navigationView.setNavigationItemSelectedListener(this);
         databasepath="Telekomunikacioni Semestri 1";
        ...
        fileUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editPdfName.getText().toString().equals("")) {
                    final Dialog dialog=new Dialog(Telekomunikacioni.this);
        ...
        sem2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Kompjuterika Semestri 2";
        ...
        sem3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Kompjuterika Semestri 3";
        ...
        sem4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Kompjuterika Semestri 4";
        ...
        sem5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Kompjuterika Semestri 5";
        ...
        sem6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databasepath="Kompjuterika Semestri 6";
    ...
    private void uploadFile(Uri data) {
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Telekomunikacioni.this, "Upload successful!", Toast.LENGTH_SHORT).show();
                reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(Telekomunikacioni.this, "File Uploaded", Toast.LENGTH_SHORT).show();
    ...
    public void displayUpload(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter=new MaterialiAdapter(Telekomunikacioni.this,upload);
                recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Telekomunikacioni.this,"Probleme me Databaze",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            Intent intent=new Intent(Telekomunikacioni.this, MainActivityHome.class);
            startActivity(intent);
        }
        else  if (id == R.id.literatura) {
            Intent intent=new Intent(Telekomunikacioni.this, DrejtimetMain.class);
            startActivity(intent);
        }
        else if (id == R.id.syllabusi) {
            Intent intent=new Intent(Telekomunikacioni.this, Syllabusi.class);
            startActivity(intent);
        } else if (id == R.id.njoftime) {
            Intent intent=new Intent(Telekomunikacioni.this, Njoftime.class);
            startActivity(intent);
        } else if (id == R.id.about) {
            Intent intent=new Intent(Telekomunikacioni.this, AboutUs.class);
            startActivity(intent);
        } else if (id == R.id.facebook) {
            url_web_page="https://notimi.uni-pr.edu/";
            Intent intent=new Intent(Telekomunikacioni.this, Facebook.class);
            startActivity(intent);
    ...
    private void logout() {
        ...
        finish();
        Toast.makeText(Telekomunikacioni.this,"User logged out",Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Telekomunikacioni.this,MainActivityLogin.class));
    }
}
