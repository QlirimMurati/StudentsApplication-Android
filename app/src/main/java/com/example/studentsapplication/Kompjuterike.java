...
public class Kompjuterike extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(this);
         ...
         databasepath="Kompjuterika Semestri 1";
        ...
        fileUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editPdfName.getText().toString().equals("")) {
                    final Dialog dialog=new Dialog(Kompjuterike.this);
  ...
  //Data e uploadimit te fajlit
       ...
       final String extension=getExtension(data);
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Kompjuterike.this, "Upload successful!", Toast.LENGTH_SHORT).show();
    ...
    public void displayUpload(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             adapter=new MaterialiAdapter(Kompjuterike.this,upload);
             recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
            Toast.makeText(Kompjuterike.this,"Probleme me Databaze",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            Intent intent=new Intent(Kompjuterike.this, MainActivityHome.class);
            startActivity(intent);
        }
        else  if (id == R.id.literatura) {
            Intent intent=new Intent(Kompjuterike.this, DrejtimetMain.class);
            startActivity(intent);
        }
        else if (id == R.id.syllabusi) {
            Intent intent=new Intent(Kompjuterike.this, Syllabusi.class);
            startActivity(intent);
        } else if (id == R.id.njoftime) {
            Intent intent=new Intent(Kompjuterike.this, Njoftime.class);
            startActivity(intent);
        } else if (id == R.id.about) {
            Intent intent=new Intent(Kompjuterike.this, AboutUs.class);
            startActivity(intent);
        }  else if (id == R.id.facebook) {
            Intent intent=new Intent(Kompjuterike.this, Facebook.class);
            startActivity(intent);

        } else if (id == R.id.online) {
            url_web_page="https://notimi.uni-pr.edu/";
            Intent intent=new Intent(Kompjuterike.this, Web_Page.class);
            startActivity(intent);
    ...
    private void logout() {
        ...
        finish();
        Toast.makeText(Kompjuterike.this,"User logged out",Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Kompjuterike.this,MainActivityLogin.class));
    }
}
